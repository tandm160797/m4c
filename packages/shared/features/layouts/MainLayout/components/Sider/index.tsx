...
import Image from '@biso24/components/Image';
import { type Modules } from '@biso24/constants/modules';
import { useMainLayout } from '@biso24/features/layouts/MainLayout';
import { mainLayout } from '@biso24/theme';
import { getModuleName } from '@biso24/utils/modules';
...
const Sider = () => {
	...
	const { siderLv1Ref, siderLv2Ref } = useMainLayout();
